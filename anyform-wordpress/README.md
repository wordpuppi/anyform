...
- **Client-Side Validation** - Real-time validation via [@wordpuppi/anyform-wasm-js](https://github.com/wordpuppi/anyform) WASM
...
The frontend uses [@wordpuppi/anyform-wasm-js](https://github.com/wordpuppi/anyform), a WebAssembly library that hydrates the server-rendered HTML with:
